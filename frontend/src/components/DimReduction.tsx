      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className={`bg-gray-900 border border-gray-800 rounded-2xl p-6 shadow-xl ${!data ? 'opacity-50 pointer-events-none' : ''}`}>
          ...
          <button 
            ...
            className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-3 rounded-xl transition-colors disabled:opacity-50 flex items-center justify-center space-x-2"
          >
        ...
        <div className={`bg-gray-900 border border-gray-800 rounded-2xl p-6 shadow-xl ${!data ? 'opacity-50 pointer-events-none' : ''}`}>
          ...
          <div className="space-y-4">
            ...
            <button 
              ...
              className="w-full bg-gray-800 hover:bg-gray-700 text-white font-bold py-3 rounded-xl transition-colors border border-gray-700 disabled:opacity-50 flex items-center justify-center space-x-2"
            >
      ...
      <div className={`bg-gray-900 border border-gray-800 rounded-2xl p-6 shadow-xl flex items-center justify-between ${!data ? 'opacity-50 pointer-events-none' : ''}`}>
        <div className="flex-1 max-w-sm">
          ...
          <div className="flex space-x-4 items-end">
            ...
            <button 
              onClick={runUMAP}
              disabled={isReducing}
              className="px-6 py-2 bg-amber-600 hover:bg-amber-500 text-white text-sm font-bold rounded-xl transition-colors disabled:opacity-50 flex items-center space-x-2 shadow-lg shadow-amber-900 shadow-opacity-20"
            >
        ...
        {reducedData && (
          <div className="flex flex-col items-end">
            ...
            <button 
              onClick={sendToSOM}
              className="px-6 py-3 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-xl transition-colors shadow-lg shadow-indigo-900 shadow-opacity-30 flex items-center space-x-2"
            >
